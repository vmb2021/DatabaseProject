...
GROUP BY Name ORDER BY MEAN DESC LIMIT 20''') #find top 20 countries with highest mean meat_consumption 1997-2017
df1 = DataFrame(c.fetchall(), columns=['Name','Wachstumsfaktor'])
print(df1)
#a = [df1['Name']]
...
Name = 'Niger' OR
Name = 'Turks and Caicos Islands' OR
Name = 'Liberia' OR
Name = 'South Sudan' OR
Name = "Oman"''')
...
fig1 = px.line(df2, x="Jahre",y="Fleischkonsum",color="Name")
fig1.show()

fig2 = px.line(df3, x="Jahre",y="Wachstumsfaktor",color="Name")
fig2.show()

fig3 = px.line(df4, x="Jahre",y="Co2_pro_Kopf",color="Name")
fig3.show()
